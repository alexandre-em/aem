...
export default function LinkedCardItem({ title, description, date, url, src, alt }: LinkedCardItemProps) {
  return (
    <a href={url} target="_blank" className="m-2">
      <div className="flex flex-wrap items-center space-x-4 rounded-md border p-4">
        <Image width="50" height="50" alt={alt || ''} className="bg-white rounded-3xl border-white border-8" src={src} />
